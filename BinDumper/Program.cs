	...
	class Program
	{
		...
		public static void Usage() {
			...
			var usage = string.Join(
				Environment.NewLine,
				"BinOutput dumper tool",
				"",
				"Usage:",
				string.Format("\techo input_file output_file [mode [class_name]] | {0} input_dir", AppDomain.CurrentDomain.FriendlyName),
				"",
				...
				string.Format(param_string, "", "mode can include optional modifier '-' at the end, e.g. 'ld-'."),
				string.Format(param_string, "", "This will disable ineritance resolution for the root class (required for some files)"),
